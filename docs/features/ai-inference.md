...
The groot boilerplate provides built-in AI inference capabilities powered by [`@earendil-works/pi-ai`](https://github.com/badlogic/pi-mono/tree/main/packages/ai). This provides a unified API to interact with various Large Language Models (LLMs) such as OpenAI, and many more.
