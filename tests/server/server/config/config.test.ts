...
import { configSchema } from "@groot/core/config/config.schema";
import { resolveString } from "@groot/core/config/config.loader";
...
describe("configSchema", () => {
  ...
  it("infers Config type from schema", () => {
    type Config = import("@groot/core/config/config.schema").Config;
