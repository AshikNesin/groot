    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <TabsList>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                type="button"
                className={`inline-flex h-full items-center justify-center whitespace-nowrap rounded-sm px-2 py-1 text-sm font-medium transition-all focus-visible:outline-none ${
                  activeSecondaryTab
      ...
      <div className="flex items-center gap-2 shrink-0">
          ...
          >
            <DropdownMenuTrigger asChild>
              <Button variant="outline" size="sm">
                <Filter className="size-3.5 md:mr-1" />
            ...
            <DropdownMenuContent align="end" className="w-48">
              ...
              <div className="max-h-[200px] overflow-y-auto">
                <DropdownMenuItem onSelect={() => setQueryParams({ queue: "all", page: 0 })}>
                  All Queues
                </DropdownMenuItem>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="outline" size="sm">
              <CalendarIcon className="size-3.5 md:mr-1" />
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem onSelect={() => handlePresetChange("today")}>Today</DropdownMenuItem>
        ...
        {queryParams.queue !== "all" && (
          <Badge variant="secondary" className="h-7 gap-1 whitespace-nowrap">
            {queryParams.queue}
            <X
